<!-- Sidebar -->
<ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: black">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('/')?>">
		...
		<div class="sidebar-brand-text mx-3">Vendas</div>
	</a>
