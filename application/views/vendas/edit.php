								...
								<div class="col-sm-6 mb-1 mb-sm-0">
									...
									<select class="custom-select contas_receber" name="venda_cliente_id" required="">
										<?php foreach ($clientes as $cliente): ?>
											<option value="<?php echo $cliente->cliente_id; ?>" <?php echo ($venda->venda_cliente_id == $cliente->cliente_id ? 'selected' : '') ?>><?php echo $cliente->cliente_nome . ' ' . $cliente->cliente_sobrenome . ' | Endereço: ' . $cliente->cliente_numero_endereco; ?></option>
										<?php endforeach; ?>
									</select>
