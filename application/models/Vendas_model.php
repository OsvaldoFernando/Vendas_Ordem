...
class Vendas_model extends CI_Model
{
	...
	public function get_by_id($venda_id = NULL)
	{
		...
		$this->db->join('clientes', 'cliente_id = venda_cliente_id', 'LEFT'); //Nome da coluna e o parâmetro
	...
	public function delete_old_products($venda_id = NULL) //delete_old_services
	{
		if ($venda_id) { //Verificar se foi passado ordem de serviço façamos a consulta no banco
