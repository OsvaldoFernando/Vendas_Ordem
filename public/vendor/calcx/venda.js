        ...
        select: function (event, ui) {
            ...
            if (ui.item.value === 'Produto não encontrado') {
                ...
                var markup = '<tr>\
                    ...
                    <td><input title="Valor unitário do produto" name="produto_preco_venda[]" value="' + produto_preco_venda + '" class="form-control form-control-user input-sm text-right money pr-1" data-cell="C' + i + '" data-format="AKZ 0,0.00" readonly></td>\
                    ...
                    <td><input title="Valor total do produto selecionado" name="produto_item_total[]" class="form-control form-control-user input-sm text-right pr-1" data-cell="F' + i + '" data-format="AKZ 0,0.00" data-formula="D' + i + '*(C' + i + '-(C' + i + '*E' + i + '))" readonly></td>\
                    <td class="text-center"><input type="hidden" name="valor_desconto_produto[]" data-cell="H' + i + '"  data-format="AKZ 0,0.00" data-formula="((C' + i + '*D' + i + ')-F' + i + ')"><button title="Remover o produto" class="btn-remove btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></button></td>\
                </tr>';
