        ...
        select: function (event, ui) {
            ...
            if (ui.item.value === 'Serviço não encontrado') {
                ...
                var markup = '<tr>\
                    ...
                    <td><input title="Valor unitário do servico" name="servico_preco[]" value="' + servico_preco + '" class="form-control form-control-user input-sm text-right money pr-1" data-cell="C' + i + '" data-format="AKZ 0,0.00" readonly></td>\
                    ...
                    <td><input title="Valor total do servico selecionado" name="servico_item_total[]" class="form-control form-control-user input-sm text-right pr-1" data-cell="F' + i + '" data-format="AKZ 0,0.00" data-formula="D' + i + '*(C' + i + '-(C' + i + '*E' + i + '))" readonly></td>\
                    <td class="text-center"><input type="hidden" name="valor_desconto_servico[]" data-cell="H' + i + '"  data-format="AKZ 0,0.00" data-formula="((C' + i + '*D' + i + ')-F' + i + ')"><button title="Remover o servico" class="btn-remove btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></button></td>\
                </tr>';
